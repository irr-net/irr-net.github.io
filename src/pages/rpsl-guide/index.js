  ...
  return (
    <Layout pageTitle={"RPSL Reference Guide"}>
      <p>
        ...
        However, you'll find references here to several RFC's that will help you
        get started with the specification. Unfortunately, due to the nature of
        RFCs and other standards documentation, they are not the most exciting
        things to read. We hope to be able to produce more user-oriented
        documentation in the future.
      </p>
      <p>
        We have provided a color-coded rating system based on what we believe is
        useful:
      </p>
      <ul>
      ...
      <section>
        ...
        <p>It is important to remember that RIPE serves as a combination of an address registry, much like ARIN, and a domain registry, much like InterNIC. As such, the RIPE database contains non-routing oriented objects.</p>
        <p>Additional documentation on the contents of the RIPE database can be found at the <a href="http://www.ripe.net/ripe/docs/alltitle.html" target="_blank" rel="noreferrer">RIPE Document Store</a>.</p>
